...
<head>
	...
	<title> Officer Guide Questionaire</title>
    ...
    <!-- external css -->
	<link rel="stylesheet" type="text/css" href="./assets/css/officer.css">
		...
		<div class="container">
			<div class="app-container">
				<div class="app-head-container">
					<img class="img-fluid" src="./assets/images/kid.png">
				</div>
					
				<div class="app-body-container">	
					<h1 id="title">COVID-19 Quickie (OFFICER) </h1>
			...
			<img class="gb1" src="./assets/images/gb1.png">
			<img class="ob1" src="./assets/images/ob1.png">
			<img class="gb4" src="./assets/images/gb4.png">
			<img class="ob4" src="./assets/images/ob4.png">
	</div>
